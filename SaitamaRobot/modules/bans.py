...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text(
                "Trying to put me against a SUDO huh?")
            return log_message
            ...
            message.reply_text(
                "Fighting this SUDO here will put civilian lives at risk.")
            return log_message
        elif user_id in DEMONS:
            message.reply_text(
                "Bring an order from my owner to fight a SUDO."
            )
            return log_message
            ...
            message.reply_text("SUDO abilities make them ban immune!")
            return log_message
        else:
    ...
    try:
        ...
        if excp.message == "Reply message not found":
            # Do not reply
            message.reply_text('Banned that Dumbass!', quote=False)
            return log
        else:
