            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="🚑 DoNOT press here",
                             url=f"https://dotesports.com/culture/news/the-origin-of-press-f-to-pay-respects"),
                         InlineKeyboardButton(
                             text="🔔 Subscribe to this channel if you love me",
                             url="https://www.youtube.com/channel/UC2MtpbwwzK4vVBSnsYDrXKA")
                     ],
                     [
                         InlineKeyboardButton(
                             text="🧾 Click here to see my private photos",
                             url="https://i.imgur.com/ihFa5bb.jpg")
                     ],
                     [
                         InlineKeyboardButton(
